...
import { COST_PER_CHARACTER, TEXT_MAX_LENGTH } from "@/features/text-to-speech/data/constants";
import { Coins } from "lucide-react";
import { useRouter } from "next/navigation";
import { useState } from "react";

export function TextInputPannel() {
  ...
  const handleGenerate = () => {
    ...
    if (!trimmed || trimmed.length <= 0 || trimmed.length > TEXT_MAX_LENGTH)
      return;
