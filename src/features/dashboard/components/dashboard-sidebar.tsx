...
function NavSection({ label, items, pathName }: NavSectionProps) {
  return (
    <SidebarGroup>
      {label && (
        <SidebarGroupLabel className="text-sm uppercase text-muted-foreground">
          {label}
        </SidebarGroupLabel>
      )}
...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
...

    {
      ...
      url: "mailto:fizzycoding@gmail.com",
      icon: Headphones,
    },
  ];
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarContent>
        <NavSection pathName={pathname} items={mainNavItems} />
        <NavSection label="Others" pathName={pathname} items={otherMenuItems} />
      </SidebarContent>
      <SidebarFooter>
        <SidebarMenu>
          <SidebarMenuItem>
